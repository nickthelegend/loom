// COPY of src/core/relay-protocol.ts — the Loom Cloud wire format, shared with
// the daemon. Keep this file in step with the original: only this header and
// import paths may differ (app/scripts/check-relay-copies.mjs enforces that).
